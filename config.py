...
MAX_RETRIES = 3
RESEARCH_TIMEOUT = 300  # seconds per Claude CLI call (5 min — generous for multi-page research)
RESEARCH_TIMEOUT_RETRIES = 1  # One auto-retry on timeout (2 attempts total), then mark failed
CLASSIFY_TIMEOUT = 60
EVOLVE_TIMEOUT = 90
