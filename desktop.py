...
def _build_menus():
    ...
    view_menu = Menu(
        ...
        [
            ...
            MenuSeparator(),
            MenuAction("Research", _menu_tab("reports")),
            MenuAction("Process", _menu_tab("process")),
            MenuAction("Review", _menu_tab("review")),
            MenuAction("Analysis", _menu_tab("analysis")),
            MenuAction("Intelligence", _menu_tab("intelligence")),
            MenuAction("Export", _menu_tab("export")),
            MenuSeparator(),
            MenuAction("Companies (Tool)", _menu_tab("companies")),
            MenuAction("Taxonomy (Tool)", _menu_tab("taxonomy")),
            MenuAction("Map (Tool)", _menu_tab("map")),
            MenuAction("Canvas (Tool)", _menu_tab("canvas")),
            MenuSeparator(),
            MenuAction("Settings", _menu_tab("settings")),
        ],
    )
    help_menu = Menu(
        "Help",
